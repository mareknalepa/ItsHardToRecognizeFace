...
JNIEXPORT void JNICALL Java_pl_polsl_pum_itshardtorecognizeface_classifier_FaceClassifier_init
(JNIEnv *env, jclass obj)
{
    classifier = createFisherFaceRecognizer();
}

JNIEXPORT void JNICALL Java_pl_polsl_pum_itshardtorecognizeface_classifier_FaceClassifier_load
...
JNIEXPORT void JNICALL Java_pl_polsl_pum_itshardtorecognizeface_classifier_FaceClassifier_train
...
JNIEXPORT jint JNICALL Java_pl_polsl_pum_itshardtorecognizeface_classifier_FaceClassifier_predict
